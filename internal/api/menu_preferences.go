...
<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Настройка меню</title><link rel="stylesheet" href="/static/css/style.css?v=12"></head><body>
{{SIDEBAR_HTML}}
