...
func ObjectProfilePage(c *gin.Context) {
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Объект: {{OBJECT_NAME}}</title><link rel="stylesheet" href="/static/css/style.css?v=6"></head><body>
{{SIDEBAR_HTML}}
<div class="main-content">
