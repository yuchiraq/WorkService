...
func GalleryPage(c *gin.Context) {
	...
	page := `<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Галерея</title><link rel="stylesheet" href="/static/css/style.css?v=12"></head><body>
