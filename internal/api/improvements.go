...
func ImprovementsPage(c *gin.Context) {
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Улучшения и ошибки</title><link rel="stylesheet" href="/static/css/style.css?v=9"></head><body>
{{SIDEBAR_HTML}}
