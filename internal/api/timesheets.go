...
func SchedulePage(c *gin.Context) {
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Расписание</title><link rel="stylesheet" href="/static/css/style.css?v=11"></head><body>
{{SIDEBAR_HTML}}
...
func TimesheetsPage(c *gin.Context) {
	...
	page := `<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>Табель</title><link rel="stylesheet" href="/static/css/style.css?v=11"></head><body>
{{SIDEBAR_HTML}}
<div class="main-content">
